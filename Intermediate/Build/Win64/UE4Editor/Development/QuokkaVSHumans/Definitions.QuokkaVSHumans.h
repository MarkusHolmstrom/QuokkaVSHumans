...
#define UE_PROJECT_NAME QuokkaVSHumans
#define UE_TARGET_NAME QuokkaVSHumansEditor
#define UE_MODULE_NAME "QuokkaVSHumans"
...
#define QUOKKAVSHUMANS_API DLLEXPORT
